...
import renderLyricsSections from "./sections/lyrics";

import { getFavorites, toggleFavorites } from "./sections/favorite";
...
const displaySection = (hash) => {
	...
	switch (hashSplit[0]) {
		...
		case "#songs":
			console.warn(`La chanson passée est ${hashSplit[1]}`);
			toggleSection("#lyrics");
			renderLyricsSections(hashSplit[1]);
			break;
	}
};
